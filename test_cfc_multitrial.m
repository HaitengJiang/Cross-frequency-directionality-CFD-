% function test_cfc_multitrial: test the cfc for multitrial
...
ntrial = 400;      %  nr of trials 
nchanX =  3;        % nr of chann
M     =  2000;     % n points 
X = zeros(ntrial,nchanX,M);

for i = 1:ntrial
   
for  j =1:nchanX     
para               = [];
para.num           = 30;                 % number of alpha cycles
...
para.nFFT     = 2;       
para.detrend  = 'yes';
CFCdist_X = cfc_dist_multitrial(X,para);
...
ntrial = 400;      % nr of trials 
nchanY =  2;        % nr of chann
M     =  2000;     % n points 
Y = zeros(ntrial,nchanY,M);
...
para.nFFT     = 2;       
para.detrend  = 'yes';
CFCdist_Y = cfc_dist_multitrial(Y,para);
